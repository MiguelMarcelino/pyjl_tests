...
import warnings
@oodef mutable struct GlobalTests <: unittest.TestCase
                    
                    _warnings_manager
                    
function new(_warnings_manager = check_warnings())
_warnings_manager = _warnings_manager
new(_warnings_manager)
end

                end
                function setUp(self::@like(GlobalTests))
self._warnings_manager = check_warnings()
__enter__(self._warnings_manager)
warnings.filterwarnings("error", module_ = "<test string>")
end

function tearDown(self::@like(GlobalTests))
__exit__(self._warnings_manager, nothing, nothing, nothing)
end

function test1(self::@like(GlobalTests))
prog_text_1 = "def wrong1():\n    a = 1\n    b = 2\n    global a\n    global b\n"
check_syntax_error(prog_text_1, lineno = 4, offset = 5)
end

function test2(self::@like(GlobalTests))
prog_text_2 = "def wrong2():\n    print(x)\n    global x\n"
check_syntax_error(prog_text_2, lineno = 3, offset = 5)
end

function test3(self::@like(GlobalTests))
prog_text_3 = "def wrong3():\n    print(x)\n    x = 2\n    global x\n"
check_syntax_error(prog_text_3, lineno = 4, offset = 5)
end

function test4(self::@like(GlobalTests))
...
__enter__(cm)
unittest.addModuleCleanup(cm.__exit__, nothing, nothing, nothing)
warnings.filterwarnings("error", module_ = "<test string>")
end
