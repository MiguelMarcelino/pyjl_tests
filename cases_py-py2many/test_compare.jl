...
mutable struct ComparisonTest <: AbstractComparisonTest
__ne__
candidates::Vector{Union{Float64, Cmp, Complex, Int64}}
set1::Vector{Union{Float64, Cmp, Complex, Int64}}
set2::Vector{Union{Tuple{Int64}, Vector{Int64}, Empty}}

                    ComparisonTest(__ne__ = unexpected, candidates::Vector{Union{Float64, Cmp, Complex, Int64}} = append!(set1, set2), set1::Vector{Union{Float64, Cmp, Complex, Int64}} = [2, 2.0, 2, 2 + 0im, Cmp(2.0)], set2::Vector{Union{Tuple{Int64}, Vector{Int64}, Empty}} = [[1], (3,), nothing, Empty()]) =
                        new(__ne__, candidates, set1, set2)
end
function test_comparisons(self::ComparisonTest)
for a in self.candidates
