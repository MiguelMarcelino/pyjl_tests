...
@oodef mutable struct DummyFloat <: object
                    #= Dummy float class for testing comparisons with Fractions =#

                    value
                    
function new(value, __rsub__ = __sub__)
...
value = value
                ...
                function _richcmp(self::@like(DummyFloat), other, op)
if isa(other, Rational)
...
function __eq__(self::@like(DummyFloat), other)
return _richcmp(self, other, operator.eq)
end

function __le__(self::@like(DummyFloat), other)
return _richcmp(self, other, operator.le)
end

function __lt__(self::@like(DummyFloat), other)
return _richcmp(self, other, operator.lt)
end

function __ge__(self::@like(DummyFloat), other)
return _richcmp(self, other, operator.ge)
end

function __gt__(self::@like(DummyFloat), other)
return _richcmp(self, other, operator.gt)
end

function __float__(self::@like(DummyFloat))
@assert(false)
end

function __sub__(self::@like(DummyFloat), other)
@assert(false)
end


@oodef mutable struct DummyRational <: object
                    #= Test comparison of Fraction with a naive rational implementation. =#

                    num
den
                    
function new(num, den)
g = math.gcd(num, den)
@mk begin
num = num
den = den
                ...
                function __eq__(self::@like(DummyRational), other)
...
function __lt__(self::@like(DummyRational), other)::Bool
return (self.num*other._denominator) < (self.den*other._numerator)
end

function __gt__(self::@like(DummyRational), other)::Bool
return (self.num*other._denominator) > (self.den*other._numerator)
end

function __le__(self::@like(DummyRational), other)::Bool
return (self.num*other._denominator) <= (self.den*other._numerator)
end

function __ge__(self::@like(DummyRational), other)::Bool
return (self.num*other._denominator) >= (self.den*other._numerator)
end

function __float__(self::@like(DummyRational))
@assert(false)
end


@oodef mutable struct DummyFraction <: fractions.Fraction
...
@oodef mutable struct CustomValue
                    
                    value
                    
function new(value, denominator::Int64 = 1, __lt__ = __eq__)
@mk begin
value = value
end
end
                ...
                function __bool__(self::@like(CustomValue))::Bool
return Bool(self.value)
end

function numerator(self::@like(CustomValue))
return self
end

function __eq__(self::@like(CustomValue), other)
...
@oodef mutable struct myint <: Int64
                ...
                function __mul__(self::@like(myint), other)
return type_(self)(parse(Int, self)*parse(Int, other))
end

function __floordiv__(self::@like(myint), other)
return type_(self)(parse(Int, self) ÷ parse(Int, other))
end

function __mod__(self::@like(myint), other)
x = type_(self)(parse(Int, self) % parse(Int, other))
return x
end

function numerator(self::@like(myint))
return type_(self)(parse(Int, self))
end

function denominator(self::@like(myint))
return type_(self)(1)
end


@oodef mutable struct FractionTest <: unittest.TestCase
                    
                    
                    
                end
                function assertTypedEquals(self::@like(FractionTest), expected, actual)
#= Asserts that both the types and values are the same. =#
@test (type_(expected) == type_(actual))
@test (expected == actual)
end

function assertTypedTupleEquals(self::@like(FractionTest), expected, actual)
...
function assertRaisesMessage(self::@like(FractionTest), exc_type, message, callable, args...)
...
function testInit(self::@like(FractionTest))
...
function testInitFromFloat(self::@like(FractionTest))
...
function testInitFromDecimal(self::@like(FractionTest))
...
function testFromString(self::@like(FractionTest))
...
function testImmutable(self::@like(FractionTest))
r = F(7, 3)
r(2, 15)
...
function testFromFloat(self::@like(FractionTest))
@test_throws
...
function testFromDecimal(self::@like(FractionTest))
@test_throws
...
function test_as_integer_ratio(self::@like(FractionTest))
...
function testLimitDenominator(self::@like(FractionTest))
...
function testConversions(self::@like(FractionTest))
assertTypedEquals(self, -1, trunc(F(-11, 10)))
assertTypedEquals(self, 1, trunc(F(11, 10)))
assertTypedEquals(self, -2, floor(Int, F(-11, 10)))
assertTypedEquals(self, -1, math.ceil(F(-11, 10)))
assertTypedEquals(self, -1, math.ceil(F(-10, 10)))
...
function testBoolGuarateesBoolReturn(self::@like(FractionTest))
numbers.register(CustomValue)
numerator_ = CustomValue(1)
r = F(numerator_)
@test self === r.numerator_
@test self === Bool(r)
numerator_ = CustomValue(0)
r = F(numerator_)
@test self === Bool(r)
end

function testRound(self::@like(FractionTest))
...
function testArithmetic(self::@like(FractionTest))
...
function testLargeArithmetic(self::@like(FractionTest))
...
function testMixedArithmetic(self::@like(FractionTest))
...
assertTypedEquals(self, 1.0 % 0.1, 1.0 % F(1, 10))
assertTypedEquals(self, 0.1, F(1, 10) % parse(Float64, "inf"))
assertTypedEquals(self, parse(Float64, "-inf"), F(1, 10) % parse(Float64, "-inf"))
assertTypedEquals(self, parse(Float64, "inf"), F(-1, 10) % parse(Float64, "inf"))
assertTypedEquals(self, -0.1, F(-1, 10) % parse(Float64, "-inf"))
...
function testMixingWithDecimal(self::@like(FractionTest))
@test_throws
@test_throws
end

function testComparisons(self::@like(FractionTest))
@test F(1, 2) < F(2, 3)
@test !(F(1, 2) < F(1, 2))
@test F(1, 2) <= F(2, 3)
@test F(1, 2) <= F(1, 2)
...
function testComparisonsDummyRational(self::@like(FractionTest))
...
function testComparisonsDummyFloat(self::@like(FractionTest))
...
function testMixedLess(self::@like(FractionTest))
@test 2 < F(5, 2)
@test !(2 < F(4, 2))
@test F(5, 2) < 3
@test !(F(4, 2) < 2)
...
@test 0.4 < F(1, 2)
@test !(0.5 < F(1, 2))
@test !(parse(Float64, "inf") < F(1, 2))
@test parse(Float64, "-inf") < F(0, 10)
@test !(parse(Float64, "nan") < F(-3, 7))
@test F(1, 2) < parse(Float64, "inf")
@test !(F(17, 12) < parse(Float64, "-inf"))
@test !(F(144, -89) < parse(Float64, "nan"))
end

function testMixedLessEqual(self::@like(FractionTest))
@test 0.5 <= F(1, 2)
@test !(0.6 <= F(1, 2))
@test F(1, 2) <= 0.5
@test !(F(1, 2) <= 0.4)
...
function testBigFloatComparisons(self::@like(FractionTest))
...
function testBigComplexComparisons(self::@like(FractionTest))
...
function testMixedEqual(self::@like(FractionTest))
@test 0.5 == F(1, 2)
@test !(0.6 == F(1, 2))
@test F(1, 2) == 0.5
@test !(F(1, 2) == 0.4)
...
@test F(4, 2) == 2
@test !(F(5, 2) == 2)
@test !(F(5, 2) == parse(Float64, "nan"))
@test !(parse(Float64, "nan") == F(3, 7))
@test !(F(5, 2) == parse(Float64, "inf"))
@test !(parse(Float64, "-inf") == F(2, 5))
end

function testStringification(self::@like(FractionTest))
...
function testApproximateCos1(self::@like(FractionTest))
x = F(1)
(i, lasts, s, fact, num, sign_) = (0, 0, F(1), 1, 1, 1)
while abs(s - lasts) > F(1, 10^9)
lasts = s
i += 2
fact *= i*(i - 1)
...
function test_copy_deepcopy_pickle(self::@like(FractionTest))
r = F(13, 7)
dr = DummyFraction(13, 7)
@test (r == loads(dumps(r)))
@test (id(r) == id(copy(r)))
@test (id(r) == id(deepcopy(r)))
@test (id(dr) != id(copy(dr)))
@test (id(dr) != id(deepcopy(dr)))
assertTypedEquals(self, dr, copy(dr))
assertTypedEquals(self, dr, deepcopy(dr))
end

function test_slots(self::@like(FractionTest))
r = F(13, 7)
@test_throws
end

function test_int_subclass(self::@like(FractionTest))
f = fractions.Fraction(myint(1*3), myint(2*3))
@test (f.numerator == 1)
@test (f.denominator == 2)
@test (type_(f.numerator) == myint)
@test (type_(f.denominator) == myint)
end
