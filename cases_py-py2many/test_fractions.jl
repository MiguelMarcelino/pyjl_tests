...
abstract type AbstractDummyFloat <: object end
abstract type AbstractDummyRational <: object end
abstract type AbstractDummyFraction <: fractions.Fraction end
...
assertTypedEquals(self, -1, ceil(F(-11, 10)))
assertTypedEquals(self, -1, ceil(F(-10, 10)))
