...
if verbose
if output
println("format("{!a} % {!a} =? {!a} ...", formatstr, args, output)")
else
println("format("{!a} % {!a} works? ...", formatstr, args)")
end
end
try
...
@oodef mutable struct FakeBytes <: object
                    
                    
                    
                end
                function __bytes__(self::@like(FakeBytes))::Array{UInt8}
return b"123"
end
...
@oodef mutable struct FormatTest <: unittest.TestCase
                ...
                function test_common_format(self::@like(FormatTest))
testcommon("%%", (), "%")
testcommon("%.1d", (1,), "1")
testcommon("%.*d", (typemax(Int), 1), overflowok = true)
...
big_ = 123456789012345678901234567890
testcommon("%d", big_, "123456789012345678901234567890")
testcommon("%d", -big_, "-123456789012345678901234567890")
testcommon("%5d", -big_, "-123456789012345678901234567890")
testcommon("%31d", -big_, "-123456789012345678901234567890")
testcommon("%32d", -big_, " -123456789012345678901234567890")
testcommon("%-32d", -big_, "-123456789012345678901234567890 ")
testcommon("%032d", -big_, "-0123456789012345678901234567890")
testcommon("%-032d", -big_, "-123456789012345678901234567890 ")
testcommon("%034d", -big_, "-000123456789012345678901234567890")
testcommon("%034d", big_, "0000123456789012345678901234567890")
testcommon("%0+34d", big_, "+000123456789012345678901234567890")
testcommon("%+34d", big_, "   +123456789012345678901234567890")
testcommon("%34d", big_, "    123456789012345678901234567890")
testcommon("%.2d", big_, "123456789012345678901234567890")
testcommon("%.30d", big_, "123456789012345678901234567890")
testcommon("%.31d", big_, "0123456789012345678901234567890")
testcommon("%32.31d", big_, " 0123456789012345678901234567890")
testcommon("%d", float(big_), "123456________________________", 6)
big_ = 1375488932362216742658885
testcommon("%x", big_, "1234567890abcdef12345")
testcommon("%x", -big_, "-1234567890abcdef12345")
testcommon("%5x", -big_, "-1234567890abcdef12345")
testcommon("%22x", -big_, "-1234567890abcdef12345")
testcommon("%23x", -big_, " -1234567890abcdef12345")
testcommon("%-23x", -big_, "-1234567890abcdef12345 ")
testcommon("%023x", -big_, "-01234567890abcdef12345")
testcommon("%-023x", -big_, "-1234567890abcdef12345 ")
testcommon("%025x", -big_, "-0001234567890abcdef12345")
testcommon("%025x", big_, "00001234567890abcdef12345")
testcommon("%0+25x", big_, "+0001234567890abcdef12345")
testcommon("%+25x", big_, "   +1234567890abcdef12345")
testcommon("%25x", big_, "    1234567890abcdef12345")
testcommon("%.2x", big_, "1234567890abcdef12345")
testcommon("%.21x", big_, "1234567890abcdef12345")
testcommon("%.22x", big_, "01234567890abcdef12345")
testcommon("%23.22x", big_, " 01234567890abcdef12345")
testcommon("%-23.22x", big_, "01234567890abcdef12345 ")
testcommon("%X", big_, "1234567890ABCDEF12345")
testcommon("%#X", big_, "0X1234567890ABCDEF12345")
testcommon("%#x", big_, "0x1234567890abcdef12345")
testcommon("%#x", -big_, "-0x1234567890abcdef12345")
testcommon("%#27x", big_, "    0x1234567890abcdef12345")
testcommon("%#-27x", big_, "0x1234567890abcdef12345    ")
testcommon("%#027x", big_, "0x00001234567890abcdef12345")
testcommon("%#.23x", big_, "0x001234567890abcdef12345")
testcommon("%#.23x", -big_, "-0x001234567890abcdef12345")
testcommon("%#27.23x", big_, "  0x001234567890abcdef12345")
testcommon("%#-27.23x", big_, "0x001234567890abcdef12345  ")
testcommon("%#027.23x", big_, "0x00001234567890abcdef12345")
testcommon("%#+.23x", big_, "+0x001234567890abcdef12345")
testcommon("%# .23x", big_, " 0x001234567890abcdef12345")
testcommon("%#+.23X", big_, "+0X001234567890ABCDEF12345")
testcommon("%#+027.23X", big_, "+0X0001234567890ABCDEF12345")
testcommon("%# 027.23X", big_, " 0X0001234567890ABCDEF12345")
testcommon("%#+27.23X", big_, " +0X001234567890ABCDEF12345")
testcommon("%#-+27.23x", big_, "+0x001234567890abcdef12345 ")
testcommon("%#- 27.23x", big_, " 0x001234567890abcdef12345 ")
big_ = 12935167030485801517351291832
testcommon("%o", big_, "12345670123456701234567012345670")
testcommon("%o", -big_, "-12345670123456701234567012345670")
testcommon("%5o", -big_, "-12345670123456701234567012345670")
testcommon("%33o", -big_, "-12345670123456701234567012345670")
testcommon("%34o", -big_, " -12345670123456701234567012345670")
testcommon("%-34o", -big_, "-12345670123456701234567012345670 ")
testcommon("%034o", -big_, "-012345670123456701234567012345670")
testcommon("%-034o", -big_, "-12345670123456701234567012345670 ")
testcommon("%036o", -big_, "-00012345670123456701234567012345670")
testcommon("%036o", big_, "000012345670123456701234567012345670")
testcommon("%0+36o", big_, "+00012345670123456701234567012345670")
testcommon("%+36o", big_, "   +12345670123456701234567012345670")
testcommon("%36o", big_, "    12345670123456701234567012345670")
testcommon("%.2o", big_, "12345670123456701234567012345670")
testcommon("%.32o", big_, "12345670123456701234567012345670")
testcommon("%.33o", big_, "012345670123456701234567012345670")
testcommon("%34.33o", big_, " 012345670123456701234567012345670")
testcommon("%-34.33o", big_, "012345670123456701234567012345670 ")
testcommon("%o", big_, "12345670123456701234567012345670")
testcommon("%#o", big_, "0o12345670123456701234567012345670")
testcommon("%#o", -big_, "-0o12345670123456701234567012345670")
testcommon("%#38o", big_, "    0o12345670123456701234567012345670")
testcommon("%#-38o", big_, "0o12345670123456701234567012345670    ")
testcommon("%#038o", big_, "0o000012345670123456701234567012345670")
testcommon("%#.34o", big_, "0o0012345670123456701234567012345670")
testcommon("%#.34o", -big_, "-0o0012345670123456701234567012345670")
testcommon("%#38.34o", big_, "  0o0012345670123456701234567012345670")
testcommon("%#-38.34o", big_, "0o0012345670123456701234567012345670  ")
testcommon("%#038.34o", big_, "0o000012345670123456701234567012345670")
testcommon("%#+.34o", big_, "+0o0012345670123456701234567012345670")
testcommon("%# .34o", big_, " 0o0012345670123456701234567012345670")
testcommon("%#+38.34o", big_, " +0o0012345670123456701234567012345670")
testcommon("%#-+38.34o", big_, "+0o0012345670123456701234567012345670 ")
testcommon("%#- 38.34o", big_, " 0o0012345670123456701234567012345670 ")
testcommon("%#+038.34o", big_, "+0o00012345670123456701234567012345670")
testcommon("%# 038.34o", big_, " 0o00012345670123456701234567012345670")
testcommon("%.33o", big_, "012345670123456701234567012345670")
testcommon("%#.33o", big_, "0o012345670123456701234567012345670")
testcommon("%#.32o", big_, "0o12345670123456701234567012345670")
testcommon("%035.33o", big_, "00012345670123456701234567012345670")
testcommon("%0#35.33o", big_, "0o012345670123456701234567012345670")
testcommon("%d", 42, "42")
testcommon("%d", -42, "-42")
...
function test_str_format(self::@like(FormatTest))
testformat("%r", "͸", "\'\\u0378\'")
testformat("%a", "͸", "\'\\u0378\'")
testformat("%r", "ʹ", "\'ʹ\'")
testformat("%a", "ʹ", "\'\\u0374\'")
...
function test_bytes_and_bytearray_format(self::@like(FormatTest))
...
function test_nul(self::@like(FormatTest))
...
function test_non_ascii(self::@like(FormatTest))
...
function test_locale(self::@like(FormatTest))
try
...
skipTest(self, "Cannot set locale: $(err)")
end
end
end
try
...
function test_optimisations(self::@like(FormatTest))
text = "abcde"
@test self === "$(text)"
@test self === "$(text)"
@test self === "$(text)s"
...
function test_precision(self::@like(FormatTest))
f = 1.2
@test (f == "1")
@test (f == "1.200")
...
function test_precision_c_limits(self::@like(FormatTest))
f = 1.2
@test_throws ValueError do cm 
f
end
...
function test_g_format_has_no_trailing_zeros(self::@like(FormatTest))
@test ("1505.0" == "1.5e+03")
@test ("%#.3g" == "1.50e+03")
@test (1505.0 == "1.5e+03")
...
function test_with_two_commas_in_format_specifier(self::@like(FormatTest))
...
function test_with_two_underscore_in_format_specifier(self::@like(FormatTest))
...
function test_with_a_commas_and_an_underscore_in_format_specifier(self::@like(FormatTest))
...
function test_with_an_underscore_and_a_comma_in_format_specifier(self::@like(FormatTest))
error_msg = re.escape("Cannot specify both \',\' and \'_\'.")
assertRaisesRegex(self, ValueError, error_msg) do 
":_,"
end
