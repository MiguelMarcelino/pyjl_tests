...
n = 10
@oodef mutable struct TestInvariantWithoutMutations
                    
                    
                    
                end
                function test_invariant(self::@like(TestInvariantWithoutMutations))
it = self.it
...
@oodef mutable struct TestTemporarilyImmutable <: TestInvariantWithoutMutations
                    
                    
                    
                end
                function test_immutable_during_iteration(self::@like(TestTemporarilyImmutable))
it = self.it
...
@oodef mutable struct TestRepeat <: {TestInvariantWithoutMutations, unittest.TestCase}
                    
                    it
                    
function new(it = repeat(nothing))
it = it
new(it)
end

                end
                function setUp(self::@like(TestRepeat))
self.it = repeat(nothing)
end


@oodef mutable struct TestXrange <: {TestInvariantWithoutMutations, unittest.TestCase}
                    
                    it::Int64
                    
function new(it::Int64 = (x for x in 0:n - 1))
it = it
new(it)
end

                end
                function setUp(self::@like(TestXrange))
self.it = (x for x in 0:n - 1)
end


@oodef mutable struct TestXrangeCustomReversed <: {TestInvariantWithoutMutations, unittest.TestCase}
                    
                    it
                    
function new(it = reversed(0:n - 1))
it = it
new(it)
end

                end
                function setUp(self::@like(TestXrangeCustomReversed))
self.it = reversed(0:n - 1)
end


@oodef mutable struct TestTuple <: {TestInvariantWithoutMutations, unittest.TestCase}
                    
                    it::Tuple
                    
function new(it::Tuple = (x for x in tuple(0:n - 1)))
it = it
new(it)
end

                end
                function setUp(self::@like(TestTuple))
self.it = (x for x in tuple(0:n - 1))
end


@oodef mutable struct TestDeque <: {TestTemporarilyImmutable, unittest.TestCase}
                    
                    it
mutate
                    
function new(it = (x for x in d), mutate = d.pop)
it = it
mutate = mutate
new(it, mutate)
end
                ...
                function setUp(self::@like(TestDeque))
d = deque(0:n - 1)
...
@oodef mutable struct TestDequeReversed <: {TestTemporarilyImmutable, unittest.TestCase}
                    
                    it
mutate
                    
function new(it = reversed(d), mutate = d.pop)
it = it
mutate = mutate
new(it, mutate)
end
                ...
                function setUp(self::@like(TestDequeReversed))
d = deque(0:n - 1)
self.it = reversed(d)
self.mutate = d.pop
end
...
@oodef mutable struct TestDictKeys <: {TestTemporarilyImmutable, unittest.TestCase}
                    
                    it
mutate
                    
function new(it = (x for x in d), mutate = d.popitem)
it = it
mutate = mutate
new(it, mutate)
end
                ...
                function setUp(self::@like(TestDictKeys))
...
@oodef mutable struct TestDictItems <: {TestTemporarilyImmutable, unittest.TestCase}
                    
                    it
mutate
                    
function new(it = (x for x in items(d)), mutate = d.popitem)
it = it
mutate = mutate
new(it, mutate)
end
                ...
                function setUp(self::@like(TestDictItems))
d = fromkeys(dict, 0:n - 1)
...
@oodef mutable struct TestDictValues <: {TestTemporarilyImmutable, unittest.TestCase}
                    
                    it
mutate
                    
function new(it = (x for x in values(d)), mutate = d.popitem)
it = it
mutate = mutate
new(it, mutate)
end
                ...
                function setUp(self::@like(TestDictValues))
d = fromkeys(dict, 0:n - 1)
...
@oodef mutable struct TestSet <: {TestTemporarilyImmutable, unittest.TestCase}
...
new(it, mutate)
                ...
                function setUp(self::@like(TestSet))
d = Set(0:n - 1)
self.it = (x for x in d)
self.mutate = d.pop
end
...
@oodef mutable struct TestList <: {TestInvariantWithoutMutations, unittest.TestCase}
...
new(it)
                ...
                function setUp(self::@like(TestList))
self.it = (x for x in 0:n - 1)
end

function test_mutation(self::@like(TestList))
d = collect(0:n - 1)
it = (x for x in d)
next(it)
next(it)
...
@oodef mutable struct TestListReversed <: {TestInvariantWithoutMutations, unittest.TestCase}
...
new(it)
                ...
                function setUp(self::@like(TestListReversed))
self.it = reversed(0:n - 1)
end

function test_mutation(self::@like(TestListReversed))
d = collect(0:n - 1)
it = reversed(d)
next(it)
next(it)
...
@oodef mutable struct BadLen <: object
                    
                    
                    
                end
                function __iter__(self::@like(BadLen))::Int64
return (x for x in 0:9)
end

function __len__(self::@like(BadLen))
throw(ErrorException("hello"))
end


@oodef mutable struct BadLengthHint <: object
                    
                    
                    
                end
                function __iter__(self::@like(BadLengthHint))::Int64
return (x for x in 0:9)
end

function __length_hint__(self::@like(BadLengthHint))
throw(ErrorException("hello"))
end


@oodef mutable struct NoneLengthHint <: object
                    
                    
                    
                end
                function __iter__(self::@like(NoneLengthHint))::Int64
return (x for x in 0:9)
end

function __length_hint__(self::@like(NoneLengthHint))
return NotImplemented
end


@oodef mutable struct TestLengthHintExceptions <: unittest.TestCase
                    
                    
                    
                end
                function test_issue1242657(self::@like(TestLengthHintExceptions))
@test_throws
@test_throws
@test_throws
@test_throws
...
function test_invalid_hint(self::@like(TestLengthHintExceptions))
