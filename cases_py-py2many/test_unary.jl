...
@oodef mutable struct UnaryOpTestCase <: unittest.TestCase
                    
                    
                    
                end
                function test_negative(self::@like(UnaryOpTestCase))
@test -2 == (0 - 2)
@test (-0 == 0)
@test (-(-2) == 2)
@test -2 == (0 - 2)
...
function test_positive(self::@like(UnaryOpTestCase))
@test (+2 == 2)
@test (+0 == 0)
@test (+(+2) == 2)
@test (+2 == 2)
...
function test_invert(self::@like(UnaryOpTestCase))
@test -2 == (0 - 2)
@test (-0 == 0)
@test (-(-2) == 2)
@test -2 == (0 - 2)
...
function test_no_overflow(self::@like(UnaryOpTestCase))
nines = repeat("9",32)
@test py""+" * nines" == (10^32 - 1)
@test py""-" * nines" == -(10^32 - 1)
@test py""~" * nines" == ~(10^32 - 1)
end

function test_negation_of_exponentiation(self::@like(UnaryOpTestCase))
@test (-(2^3) == -8)
@test (-2^3 == -8)
@test (-(2^4) == -16)
@test (-2^4 == 16)
...
function test_bad_types(self::@like(UnaryOpTestCase))
for op in ("+", "-", "~")
@test_throws
@test_throws
end
...
type_annotation_tests = TypeAnnotationTests()
test_lazy_create_annotations(type_annotation_tests)
test_setting_annotations(type_annotation_tests)
test_annotations_getset_raises(type_annotation_tests)
test_annotations_are_created_correctly(type_annotation_tests)
test_descriptor_still_works(type_annotation_tests)
