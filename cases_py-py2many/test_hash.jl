...
abstract type AbstractDefaultHash <: object end
abstract type AbstractFixedHash <: object end
abstract type AbstractOnlyEquality <: object end
abstract type AbstractOnlyInequality <: object end
...
abstract type AbstractNoHash <: object end
abstract type AbstractHashInheritanceTestCase end
abstract type AbstractDefaultIterSeq <: object end
...
repr_
                    ...
                    DatetimeDateTests(repr_ = repr(date(1066, 10, 14))) =
                        new(repr_)
end
...
repr_
                    ...
                    DatetimeDatetimeTests(repr_ = repr(datetime(1, 2, 3, 4, 5, 6, 7))) =
                        new(repr_)
end
...
repr_
                    ...
                    DatetimeTimeTests(repr_ = repr(time(0))) =
                        new(repr_)
end
