...
@oodef mutable struct MyException <: Exception
                ...
                function __new__(cls::@like(MyException), args...)
return object()
end


@oodef mutable struct TestRaise <: unittest.TestCase
                    
                    
                    
                end
                function test_invalid_reraise(self::@like(TestRaise))
try
error()
catch exn
 let e = exn
...
function test_reraise(self::@like(TestRaise))
try
try
throw(IndexError())
catch exn
...
function test_except_reraise(self::@like(TestRaise))
function reraise()
try
throw(TypeError("foo"))
catch exn
...
function test_finally_reraise(self::@like(TestRaise))
function reraise()
try
throw(TypeError("foo"))
catch exn
...
function test_nested_reraise(self::@like(TestRaise))
...
function test_raise_from_None(self::@like(TestRaise))
try
try
throw(TypeError("foo"))
catch exn
...
function test_with_reraise1(self::@like(TestRaise))
function reraise()
try
throw(TypeError("foo"))
catch exn
...
function test_with_reraise2(self::@like(TestRaise))
function reraise()
try
throw(TypeError("foo"))
catch exn
...
@resumable function test_yield_reraise(self::@like(TestRaise))
g = reraise()
next(g)
@test_throws
@test_throws
...
function test_erroneous_exception(self::@like(TestRaise))
try
throw(MyException)
catch exn
...
function test_new_returns_invalid_instance(self::@like(TestRaise))
@test_throws TypeError do 
throw(MyException)
end
end

function test_assert_with_tuple_arg(self::@like(TestRaise))
try
@assert(false)
catch exn
 let e = exn
...
@oodef mutable struct TestCause <: unittest.TestCase
                    
                    
                    
                end
                function testCauseSyntax(self::@like(TestCause))
try
try
try
throw(TypeError)
...
function test_invalid_cause(self::@like(TestCause))
try
throw(IndexError)
catch exn
 let e = exn
...
function test_class_cause(self::@like(TestCause))
try
throw(IndexError)
catch exn
 let e = exn
...
function test_instance_cause(self::@like(TestCause))
cause = KeyError()
try
throw(IndexError)
catch exn
 let e = exn
if e isa IndexError
@test self === e.__cause__
end
end
end
end

function test_erroneous_cause(self::@like(TestCause))
try
throw(IndexError)
catch exn
if exn isa RuntimeError
...
@oodef mutable struct TestTraceback <: unittest.TestCase
                    
                    
                    
                end
                function test_sets_traceback(self::@like(TestTraceback))
try
throw(IndexError())
catch exn
 let e = exn
...
function test_accepts_traceback(self::@like(TestTraceback))
tb = get_tb()
try
...
@oodef mutable struct TestTracebackType <: unittest.TestCase
                    
                    
                    
                end
                function raiser(self::@like(TestTracebackType))
throw(ValueError)
end

function test_attrs(self::@like(TestTracebackType))
try
raiser(self)
catch exn
 let exc = exn
...
tb.tb_next = nothing
@test self === tb.tb_next
new_tb = get_tb()
tb.tb_next = new_tb
@test self === tb.tb_next
end

function test_constructor(self::@like(TestTracebackType))
other_tb = get_tb()
frame = sys._getframe()
...
@test (tb.tb_lasti == 1)
@test (tb.tb_lineno == 2)
tb = types.TracebackType(nothing, frame, 1, 2)
...
@oodef mutable struct ContextManager
                    
                    
                    
                end
                function __enter__(self::@like(ContextManager))
#= pass =#
end

function __exit__(self::@like(ContextManager), t, v, tb)
xyzzy
end
...
@oodef mutable struct TestContext <: unittest.TestCase
                    
                    
                    
                end
                function test_instance_context_instance_raise(self::@like(TestContext))
context = IndexError()
try
try
throw(context)
...
function test_class_context_instance_raise(self::@like(TestContext))
context = IndexError
try
try
throw(context)
...
function test_class_context_class_raise(self::@like(TestContext))
context = IndexError
try
try
throw(context)
...
function test_c_exception_context(self::@like(TestContext))
try
try
1 / 0
catch exn
...
function test_c_exception_raise(self::@like(TestContext))
try
try
1 / 0
catch exn
...
function test_noraise_finally(self::@like(TestContext))
try
try
#= pass =#
finally
...
function test_raise_finally(self::@like(TestContext))
try
try
1 / 0
finally
...
function test_context_manager(self::@like(TestContext))
try
ContextManager() do 
1 / 0
end
...
function test_cycle_broken(self::@like(TestContext))
try
try
1 / 0
catch exn
...
function test_reraise_cycle_broken(self::@like(TestContext))
try
try
xyzzy
catch exn
...
function test_not_last(self::@like(TestContext))
...
@test self === raised.__context__
end

function test_3118(self::@like(TestContext))
function f()
g = gen()
g()
try
...
function test_3611(self::@like(TestContext))
function f()
x = C()
try
try
...
f()
@test (ZeroDivisionError == cm.unraisable.exc_type)
end
end


@oodef mutable struct TestRemovedFunctionality <: unittest.TestCase
                    
                    
                    
                end
                function test_tuples(self::@like(TestRemovedFunctionality))
try
...
function test_strings(self::@like(TestRemovedFunctionality))
try
throw("foo")
catch exn
if exn isa TypeError
