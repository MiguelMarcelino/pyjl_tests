...
abstract type AbstractMySeed <: object end
abstract type AbstractSeqSet <: abc.Sequence end
...
abstract type AbstractBadInt <: int end
abstract type AbstractTestDistributions end
abstract type AbstractTestRandomSubclassing end
abstract type AbstractSubclass <: random.Random end
abstract type AbstractSubClass1 <: random.Random end
abstract type AbstractSubClass2 <: random.Random end
...
expovariate_returned_value = expovariate(1.0 / beta)
...
returned_value = gammavariate(alpha, beta)
