...
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", b"*$"), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", Vector{UInt8}(b"*$")), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", memoryview(b"*$")), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", array("B", b"*$")), b"01a*b$cd")
...
eq(b64decode(data, altchars), res)
eq(b64decode(data_str, altchars), res)
eq(b64decode(data, altchars_str), res)
eq(b64decode(data_str, altchars_str), res)
end
for (data, res) in collect(tests)
...
assertRaises(self, binascii.Error) do 
b64decode(decode(bstr, "ascii"), true)
end
end
...
eq(b32decode(data, map01), res)
eq(b32decode(data_str, map01), res)
eq(b32decode(data, map01_str), res)
eq(b32decode(data_str, map01_str), res)
...
eq(a85encode(data, false), res, data)
eq(a85encode(data, true), append!((b"<~" + res), b"~>"), data)
end
check_other_types(self, base64.a85encode, b"www.python.org", b"GB\\6`E-ZP=Df.1GEb>")
@test_throws TypeError base64.a85encode("")
eq(a85encode(b"www.python.org", 7, false), b"GB\\6`E-\nZP=Df.1\nGEb>")
eq(a85encode(b"\x00\x00\x00\x00www.python.org", 7, false), b"zGB\\6`E\n-ZP=Df.\n1GEb>")
eq(a85encode(b"www.python.org", 7, true), b"<~GB\\6`\nE-ZP=Df\n.1GEb>\n~>")
eq(a85encode(repeat(b" ",8), true, false), b"yy")
eq(a85encode(repeat(b" ",7), true, false), b"y+<Vd")
eq(a85encode(repeat(b" ",6), true, false), b"y+<U")
eq(a85encode(repeat(b" ",5), true, false), b"y+9")
end
...
eq(a85decode(data, false), res, data)
eq(a85decode(decode(data, "ascii"), false), res, data)
eq(a85decode(append!((b"<~" + data), b"~>"), true), res, data)
eq(a85decode(data + b"~>", true), res, data)
eq(a85decode("<~%s~>" % decode(data, "ascii"), true), res, data)
end
eq(a85decode(b"yy", true, false), repeat(b" ",8))
eq(a85decode(b"y+<Vd", true, false), repeat(b" ",7))
eq(a85decode(b"y+<U", true, false), repeat(b" ",6))
eq(a85decode(b"y+9", true, false), repeat(b" ",5))
...
eq = self.assertEqual
eq(a85encode(b"x", true), b"GQ7^D")
eq(a85encode(b"xx", true), b"G^'2g")
eq(a85encode(b"xxx", true), b"G^+H5")
eq(a85encode(b"xxxx", true), b"G^+IX")
eq(a85encode(b"xxxxx", true), b"G^+IXGQ7^D")
...
eq = self.assertEqual
eq(b85encode(b"x", true), b"cmMzZ")
eq(b85encode(b"xx", true), b"cz6H+")
eq(b85encode(b"xxx", true), b"czAdK")
eq(b85encode(b"xxxx", true), b"czAet")
eq(b85encode(b"xxxxx", true), b"czAetcmMzZ")
...
@test_throws ValueError bytes([c])() do 
a85decode(append!(b"!!!!", bytes([c])), false)
end
@test_throws ValueError bytes([c])() do 
a85decode(append!(append!(b"<~!!!!", bytes([c])), b"~>"), true)
end
end
...
infp = IOBuffer(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}")
outfp = BytesIO()
encode(base64, "UTF-8")(infp, outfp)
eq(getvalue(outfp), b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0\nNTY3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==\n")
@test_throws TypeError encode(base64, "UTF-8")(StringIO("abc"), BytesIO())
@test_throws TypeError encode(base64, "UTF-8")(IOBuffer(b"abc"), StringIO())
@test_throws TypeError encode(base64, "UTF-8")(StringIO("abc"), StringIO())
end
...
@test (getvalue(outfp) == b"www.python.org")
@test_throws TypeError encode(base64, "UTF-8")(StringIO("YWJj\n"), BytesIO())
@test_throws TypeError encode(base64, "UTF-8")(IOBuffer(b"YWJj\n"), StringIO())
@test_throws TypeError encode(base64, "UTF-8")(StringIO("YWJj\n"), StringIO())
end
...
eq(base64.b64encode(b"\xd3V\xbeo\xf7\x1d", b"*$"), b"01a*b$cd")
eq(base64.b64encode(b"\xd3V\xbeo\xf7\x1d", Vector{UInt8}(b"*$")), b"01a*b$cd")
eq(base64.b64encode(b"\xd3V\xbeo\xf7\x1d", memoryview(b"*$")), b"01a*b$cd")
eq(base64.b64encode(b"\xd3V\xbeo\xf7\x1d", array("B", b"*$")), b"01a*b$cd")
check_other_types(self, base64.b64encode, b"abcd", b"YWJjZA==")
check_encode_type_errors(self, base64.b64encode)
@test_throws TypeError base64.b64encode(b"", "*\$")
...
eq(base64.b64decode(data, altchars_str), res)
eq(base64.b64decode(data_str, altchars_str), res)
end
for (data, res) in collect(tests)
...
assertRaises(self, binascii.Error) do 
base64.b64decode(bstr, true)
end
assertRaises(self, binascii.Error) do 
base64.b64decode(decode(bstr, "ascii"), true)
end
end
res = b"\xfb\xef\xbe\xff\xff\xff"
...
eq(base64.b32decode(data, map01_str), res)
eq(base64.b32decode(data_str, map01_str), res)
@test_throws binascii.Error base64.b32decode(data)
@test_throws binascii.Error base64.b32decode(data_str)
end
end
...
eq(base64.a85encode(data, false), res, data)
eq(base64.a85encode(data, true), append!((b"<~" + res), b"~>"), data)
end
check_other_types(self, base64.a85encode, b"www.python.org", b"GB\\6`E-ZP=Df.1GEb>")
@test_throws TypeError base64.a85encode("")
eq(base64.a85encode(b"www.python.org", 7, false), b"GB\\6`E-\nZP=Df.1\nGEb>")
eq(base64.a85encode(b"\x00\x00\x00\x00www.python.org", 7, false), b"zGB\\6`E\n-ZP=Df.\n1GEb>")
eq(base64.a85encode(b"www.python.org", 7, true), b"<~GB\\6`\nE-ZP=Df\n.1GEb>\n~>")
eq(base64.a85encode(repeat(b" ",8), true, false), b"yy")
eq(base64.a85encode(repeat(b" ",7), true, false), b"y+<Vd")
eq(base64.a85encode(repeat(b" ",6), true, false), b"y+<U")
eq(base64.a85encode(repeat(b" ",5), true, false), b"y+9")
end
...
eq(base64.a85decode(data, false), res, data)
eq(base64.a85decode(decode(data, "ascii"), false), res, data)
eq(base64.a85decode(append!((b"<~" + data), b"~>"), true), res, data)
eq(base64.a85decode(data + b"~>", true), res, data)
eq(base64.a85decode("<~%s~>" % decode(data, "ascii"), true), res, data)
end
eq(base64.a85decode(b"yy", true, false), repeat(b" ",8))
eq(base64.a85decode(b"y+<Vd", true, false), repeat(b" ",7))
eq(base64.a85decode(b"y+<U", true, false), repeat(b" ",6))
eq(base64.a85decode(b"y+9", true, false), repeat(b" ",5))
check_other_types(self, base64.a85decode, b"GB\\6`E-ZP=Df.1GEb>", b"www.python.org")
end
...
function test_a85_padding(self::BaseXYTestCase)
eq = self.assertEqual
eq(base64.a85encode(b"x", true), b"GQ7^D")
eq(base64.a85encode(b"xx", true), b"G^'2g")
eq(base64.a85encode(b"xxx", true), b"G^+H5")
eq(base64.a85encode(b"xxxx", true), b"G^+IX")
eq(base64.a85encode(b"xxxxx", true), b"G^+IXGQ7^D")
...
function test_b85_padding(self::BaseXYTestCase)
eq = self.assertEqual
eq(base64.b85encode(b"x", true), b"cmMzZ")
eq(base64.b85encode(b"xx", true), b"cz6H+")
eq(base64.b85encode(b"xxx", true), b"czAdK")
eq(base64.b85encode(b"xxxx", true), b"czAet")
eq(base64.b85encode(b"xxxxx", true), b"czAetcmMzZ")
...
for c in illegal
@test_throws ValueError bytes([c])() do 
base64.a85decode(append!(b"!!!!", bytes([c])))
end
@test_throws ValueError bytes([c])() do 
base64.a85decode(append!(b"!!!!", bytes([c])), false)
end
@test_throws ValueError bytes([c])() do 
base64.a85decode(append!(append!(b"<~!!!!", bytes([c])), b"~>"), true)
end
end
@test_throws ValueError base64.a85decode(b"malformed", true)
@test_throws ValueError base64.a85decode(b"<~still malformed", true)
...
for c in illegal
@test_throws ValueError bytes([c])() do 
base64.b85decode(append!(b"0000", bytes([c])))
end
end
@test_throws ValueError base64.b85decode(b"|")
@test_throws ValueError base64.b85decode(b"|N")
