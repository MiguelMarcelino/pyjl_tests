...
function check_type_errors(self, f)
...
function test_encodebytes(self)
eq = self.assertEqual
eq(encodebytes(b"www.python.org"), b"d3d3LnB5dGhvbi5vcmc=\n")
eq(encodebytes(b"a"), b"YQ==\n")
eq(encodebytes(b"ab"), b"YWI=\n")
eq(encodebytes(b"abc"), b"YWJj\n")
eq(encodebytes(b""), b"")
eq(encodebytes(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}"), b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0\nNTY3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==\n")
eq(encodebytes(Vector{UInt8}(b"abc")), b"YWJj\n")
eq(encodebytes(memoryview(b"abc")), b"YWJj\n")
eq(encodebytes(array("B", b"abc")), b"YWJj\n")
check_type_errors(self, base64.encodebytes)
end

function test_decodebytes(self)
eq = self.assertEqual
eq(decodebytes(b"d3d3LnB5dGhvbi5vcmc=\n"), b"www.python.org")
eq(decodebytes(b"YQ==\n"), b"a")
eq(decodebytes(b"YWI=\n"), b"ab")
eq(decodebytes(b"YWJj\n"), b"abc")
eq(decodebytes(b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0\nNTY3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==\n"), b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}")
eq(decodebytes(b""), b"")
eq(decodebytes(Vector{UInt8}(b"YWJj\n")), b"abc")
eq(decodebytes(memoryview(b"YWJj\n")), b"abc")
eq(decodebytes(array("B", b"YWJj\n")), b"abc")
...
@test_throws TypeError base64.encode(StringIO("abc"), BytesIO())
@test_throws TypeError base64.encode(IOBuffer(b"abc"), StringIO())
@test_throws TypeError base64.encode(StringIO("abc"), StringIO())
end
...
@test_throws TypeError base64.encode(StringIO("YWJj\n"), BytesIO())
@test_throws TypeError base64.encode(IOBuffer(b"YWJj\n"), StringIO())
@test_throws TypeError base64.encode(StringIO("YWJj\n"), StringIO())
end
...
function check_encode_type_errors(self, f)
@test_throws TypeError f("")
@test_throws TypeError f([])
end

function check_decode_type_errors(self, f)
@test_throws TypeError f([])
end

function check_other_types(self, f, bytes_data, expected)
eq = self.assertEqual
...
function check_multidimensional(self, f, data)
...
function check_nonbyte_element_format(self, f, data)
...
function test_b64encode(self)
eq = self.assertEqual
eq(b64encode(b"www.python.org"), b"d3d3LnB5dGhvbi5vcmc=")
eq(b64encode(b"\x00"), b"AA==")
eq(b64encode(b"a"), b"YQ==")
eq(b64encode(b"ab"), b"YWI=")
eq(b64encode(b"abc"), b"YWJj")
eq(b64encode(b""), b"")
eq(b64encode(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}"), b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0NTY3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", altchars = b"*$"), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", altchars = Vector{UInt8}(b"*$")), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", altchars = memoryview(b"*$")), b"01a*b$cd")
eq(b64encode(b"\xd3V\xbeo\xf7\x1d", altchars = array("B", b"*$")), b"01a*b$cd")
check_other_types(self, base64.b64encode, b"abcd", b"YWJjZA==")
check_encode_type_errors(self, base64.b64encode)
@test_throws TypeError base64.b64encode(b"", altchars = "*\$")
eq(standard_b64encode(b"www.python.org"), b"d3d3LnB5dGhvbi5vcmc=")
eq(standard_b64encode(b"a"), b"YQ==")
eq(standard_b64encode(b"ab"), b"YWI=")
eq(standard_b64encode(b"abc"), b"YWJj")
eq(standard_b64encode(b""), b"")
eq(standard_b64encode(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}"), b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0NTY3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==")
check_other_types(self, base64.standard_b64encode, b"abcd", b"YWJjZA==")
check_encode_type_errors(self, base64.standard_b64encode)
eq(urlsafe_b64encode(b"\xd3V\xbeo\xf7\x1d"), b"01a-b_cd")
...
eq(b64decode(data), res)
eq(b64decode(decode(data, "ascii")), res)
end
...
eq(b64decode(data, altchars = altchars), res)
eq(b64decode(data_str, altchars = altchars), res)
eq(b64decode(data, altchars = altchars_str), res)
eq(b64decode(data_str, altchars = altchars_str), res)
end
for (data, res) in collect(tests)
eq(standard_b64decode(data), res)
eq(standard_b64decode(decode(data, "ascii")), res)
end
...
eq(urlsafe_b64decode(data), res)
eq(urlsafe_b64decode(decode(data, "ascii")), res)
end
...
b64decode(bstr, validate = true)
end
assertRaises(self, binascii.Error) do 
b64decode(decode(bstr, "ascii"), validate = true)
end
end
res = b"\xfb\xef\xbe\xff\xff\xff"
@test (b64decode(b"++[[//]]", b"[]") == res)
@test (urlsafe_b64decode(b"++--//__") == res)
end

function test_b32encode(self)
eq = self.assertEqual
eq(b32encode(b""), b"")
eq(b32encode(b"\x00"), b"AA======")
eq(b32encode(b"a"), b"ME======")
eq(b32encode(b"ab"), b"MFRA====")
eq(b32encode(b"abc"), b"MFRGG===")
eq(b32encode(b"abcd"), b"MFRGGZA=")
eq(b32encode(b"abcde"), b"MFRGGZDF")
check_other_types(self, base64.b32encode, b"abcd", b"MFRGGZA=")
check_encode_type_errors(self, base64.b32encode)
end

function test_b32decode(self)
eq = self.assertEqual
tests = OrderedDict(b"" => b"", b"AA======" => b"\x00", b"ME======" => b"a", b"MFRA====" => b"ab", b"MFRGG===" => b"abc", b"MFRGGZA=" => b"abcd", b"MFRGGZDF" => b"abcde")
for (data, res) in collect(tests)
eq(b32decode(data), res)
eq(b32decode(decode(data, "ascii")), res)
end
check_other_types(self, base64.b32decode, b"MFRGG===", b"abc")
check_decode_type_errors(self, base64.b32decode)
end

function test_b32decode_casefold(self)
eq = self.assertEqual
...
for (data, res) in collect(tests)
eq(b32decode(data, true), res)
eq(b32decode(decode(data, "ascii"), true), res)
end
@test_throws binascii.Error base64.b32decode(b"me======")
@test_throws binascii.Error base64.b32decode("me======")
eq(b32decode(b"MLO23456"), b"b\xdd\xad\xf3\xbe")
eq(b32decode("MLO23456"), b"b\xdd\xad\xf3\xbe")
...
eq(b32decode(data, map01 = map01), res)
eq(b32decode(data_str, map01 = map01), res)
eq(b32decode(data, map01 = map01_str), res)
eq(b32decode(data_str, map01 = map01_str), res)
@test_throws binascii.Error base64.b32decode(data)
@test_throws binascii.Error base64.b32decode(data_str)
end
end

function test_b32decode_error(self)
...
assertRaises(self, binascii.Error) do 
b32decode(decode(data, "ascii"))
end
end
end
end

function test_b32hexencode(self)
...
@test (b32hexencode(to_encode) == expected)
end
end
end

function test_b32hexencode_other_types(self)
check_other_types(self, base64.b32hexencode, b"abcd", b"C5H66P0=")
check_encode_type_errors(self, base64.b32hexencode)
end

function test_b32hexdecode(self)
...
@test (b32hexdecode(to_decode, casefold) == expected)
@test (b32hexdecode(decode(to_decode, "ascii"), casefold) == expected)
end
end
end

function test_b32hexdecode_other_types(self)
check_other_types(self, base64.b32hexdecode, b"C5H66===", b"abc")
check_decode_type_errors(self, base64.b32hexdecode)
end

function test_b32hexdecode_error(self)
...
assertRaises(self, binascii.Error) do 
b32hexdecode(decode(data, "ascii"))
end
end
end
end

function test_b16encode(self)
eq = self.assertEqual
eq(b16encode(b"\x01\x02\xab\xcd\xef"), b"0102ABCDEF")
eq(b16encode(b"\x00"), b"00")
check_other_types(self, base64.b16encode, b"\x01\x02\xab\xcd\xef", b"0102ABCDEF")
check_encode_type_errors(self, base64.b16encode)
end

function test_b16decode(self)
eq = self.assertEqual
eq(b16decode(b"0102ABCDEF"), b"\x01\x02\xab\xcd\xef")
eq(b16decode("0102ABCDEF"), b"\x01\x02\xab\xcd\xef")
eq(b16decode(b"00"), b"\x00")
eq(b16decode("00"), b"\x00")
@test_throws binascii.Error base64.b16decode(b"0102abcdef")
@test_throws binascii.Error base64.b16decode("0102abcdef")
eq(b16decode(b"0102abcdef", true), b"\x01\x02\xab\xcd\xef")
eq(b16decode("0102abcdef", true), b"\x01\x02\xab\xcd\xef")
check_other_types(self, base64.b16decode, b"0102ABCDEF", b"\x01\x02\xab\xcd\xef")
check_decode_type_errors(self, base64.b16decode)
eq(b16decode(Vector{UInt8}(b"0102abcdef"), true), b"\x01\x02\xab\xcd\xef")
eq(b16decode(memoryview(b"0102abcdef"), true), b"\x01\x02\xab\xcd\xef")
eq(b16decode(array("B", b"0102abcdef"), true), b"\x01\x02\xab\xcd\xef")
@test_throws binascii.Error base64.b16decode("0102AG")
@test_throws binascii.Error base64.b16decode("010")
end

function test_a85encode(self)
eq = self.assertEqual
...
for (data, res) in collect(tests)
eq(a85encode(data), res, data)
eq(a85encode(data, adobe = false), res, data)
eq(a85encode(data, adobe = true), append!((b"<~" + res), b"~>"), data)
end
check_other_types(self, base64.a85encode, b"www.python.org", b"GB\\6`E-ZP=Df.1GEb>")
@test_throws TypeError base64.a85encode("")
eq(a85encode(b"www.python.org", wrapcol = 7, adobe = false), b"GB\\6`E-\nZP=Df.1\nGEb>")
eq(a85encode(b"\x00\x00\x00\x00www.python.org", wrapcol = 7, adobe = false), b"zGB\\6`E\n-ZP=Df.\n1GEb>")
eq(a85encode(b"www.python.org", wrapcol = 7, adobe = true), b"<~GB\\6`\nE-ZP=Df\n.1GEb>\n~>")
eq(a85encode(repeat(b" ",8), foldspaces = true, adobe = false), b"yy")
eq(a85encode(repeat(b" ",7), foldspaces = true, adobe = false), b"y+<Vd")
eq(a85encode(repeat(b" ",6), foldspaces = true, adobe = false), b"y+<U")
eq(a85encode(repeat(b" ",5), foldspaces = true, adobe = false), b"y+9")
end

function test_b85encode(self)
eq = self.assertEqual
...
for (data, res) in collect(tests)
eq(a85decode(data), res, data)
eq(a85decode(data, adobe = false), res, data)
eq(a85decode(decode(data, "ascii"), adobe = false), res, data)
eq(a85decode(append!((b"<~" + data), b"~>"), adobe = true), res, data)
eq(a85decode(data + b"~>", adobe = true), res, data)
eq(a85decode("<~%s~>" % decode(data, "ascii"), adobe = true), res, data)
end
eq(a85decode(b"yy", foldspaces = true, adobe = false), repeat(b" ",8))
eq(a85decode(b"y+<Vd", foldspaces = true, adobe = false), repeat(b" ",7))
eq(a85decode(b"y+<U", foldspaces = true, adobe = false), repeat(b" ",6))
eq(a85decode(b"y+9", foldspaces = true, adobe = false), repeat(b" ",5))
check_other_types(self, base64.a85decode, b"GB\\6`E-ZP=Df.1GEb>", b"www.python.org")
end

function test_b85decode(self)
eq = self.assertEqual
...
for (data, res) in collect(tests)
eq(b85decode(data), res)
eq(b85decode(decode(data, "ascii")), res)
end
check_other_types(self, base64.b85decode, b"cXxL#aCvlSZ*DGca%T", b"www.python.org")
end

function test_a85_padding(self)
eq = self.assertEqual
eq(a85encode(b"x", pad = true), b"GQ7^D")
eq(a85encode(b"xx", pad = true), b"G^'2g")
eq(a85encode(b"xxx", pad = true), b"G^+H5")
eq(a85encode(b"xxxx", pad = true), b"G^+IX")
eq(a85encode(b"xxxxx", pad = true), b"G^+IXGQ7^D")
eq(a85decode(b"GQ7^D"), b"x\x00\x00\x00")
eq(a85decode(b"G^'2g"), b"xx\x00\x00")
eq(a85decode(b"G^+H5"), b"xxx\x00")
eq(a85decode(b"G^+IX"), b"xxxx")
eq(a85decode(b"G^+IXGQ7^D"), b"xxxxx\x00\x00\x00")
end

function test_b85_padding(self)
eq = self.assertEqual
eq(b85encode(b"x", pad = true), b"cmMzZ")
eq(b85encode(b"xx", pad = true), b"cz6H+")
eq(b85encode(b"xxx", pad = true), b"czAdK")
eq(b85encode(b"xxxx", pad = true), b"czAet")
eq(b85encode(b"xxxxx", pad = true), b"czAetcmMzZ")
eq(b85decode(b"cmMzZ"), b"x\x00\x00\x00")
eq(b85decode(b"cz6H+"), b"xx\x00\x00")
eq(b85decode(b"czAdK"), b"xxx\x00")
eq(b85decode(b"czAet"), b"xxxx")
eq(b85decode(b"czAetcmMzZ"), b"xxxxx\x00\x00\x00")
end

function test_a85decode_errors(self)
illegal = (set(0:31) | set(118:255)) - set(b" \t\n\r\x0b")
for c in illegal
@test_throws ValueError msg = bytes([c])() do 
a85decode(append!(b"!!!!", bytes([c])))
end
@test_throws ValueError msg = bytes([c])() do 
a85decode(append!(b"!!!!", bytes([c])), adobe = false)
end
@test_throws ValueError msg = bytes([c])() do 
a85decode(append!(append!(b"<~!!!!", bytes([c])), b"~>"), adobe = true)
end
end
@test_throws ValueError base64.a85decode(b"malformed", adobe = true)
@test_throws ValueError base64.a85decode(b"<~still malformed", adobe = true)
@test_throws ValueError base64.a85decode(b"<~~>")
@test_throws ValueError base64.a85decode(b"<~~>", adobe = false)
a85decode(b"<~~>", adobe = true)
@test_throws ValueError base64.a85decode(b"abcx", adobe = false)
@test_throws ValueError base64.a85decode(b"abcdey", adobe = false)
@test_throws ValueError base64.a85decode(b"a b\nc", adobe = false, ignorechars = b"")
@test_throws ValueError base64.a85decode(b"s", adobe = false)
@test_throws ValueError base64.a85decode(b"s8", adobe = false)
@test_throws ValueError base64.a85decode(b"s8W", adobe = false)
@test_throws ValueError base64.a85decode(b"s8W-", adobe = false)
@test_throws ValueError base64.a85decode(b"s8W-\"", adobe = false)
end

function test_b85decode_errors(self)
illegal = append!(append!(collect(0:32), collect(b"\"\',./:[\\]")), collect(128:255))
for c in illegal
@test_throws ValueError msg = bytes([c])() do 
b85decode(append!(b"0000", bytes([c])))
end
end
...
function test_decode_nonascii_str(self)
...
function test_ErrorHeritage(self)
@test binascii.Error <: ValueError
end

function test_RFC4648_test_cases(self)
...
if ispath(os_helper.TESTFN)
unlink(os_helper.TESTFN)
end
end

function get_output(self)
return assert_python_ok("-m", "base64", args...).out
end

function test_encode_decode(self)
...
function test_encode_file(self)
...
function test_encode_from_stdin(self)
spawn_python("-m", "base64", "-e") do proc 
