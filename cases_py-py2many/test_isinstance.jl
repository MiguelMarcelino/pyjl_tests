...
@oodef mutable struct I <: object
                    
                    __class__
                    
function new(__class__ = property(getclass))
__class__ = __class__
new(__class__)
end

                end
                function getclass(self::@like(I))
return nothing
end
...
function new(__bases__ = property(getbases))
__bases__ = __bases__
new(__bases__)
end

                end
                function getbases(self::@like(C))::Tuple
return ()
end


@oodef mutable struct E <: object
...
new(__class__)
                ...
                function getclass(self::@like(I))::E
return E()
end
...
@oodef mutable struct TestIsInstanceExceptions <: unittest.TestCase
                    
                    
                    
                end
                function test_class_has_no_bases(self::@like(TestIsInstanceExceptions))
@test (false == isa(I(), C()))
end

function test_bases_raises_other_than_attribute_error(self::@like(TestIsInstanceExceptions))
@test_throws
end

function test_dont_mask_non_attribute_error(self::@like(TestIsInstanceExceptions))
@test_throws
end

function test_mask_attribute_error(self::@like(TestIsInstanceExceptions))
@test_throws
end

function test_isinstance_dont_mask_non_attribute_error(self::@like(TestIsInstanceExceptions))
c = C()
@test_throws
@test_throws
end
...
@oodef mutable struct TestIsSubclassExceptions <: unittest.TestCase
                    
                    
                    
                end
                function test_dont_mask_non_attribute_error(self::@like(TestIsSubclassExceptions))
@test_throws
end

function test_mask_attribute_error(self::@like(TestIsSubclassExceptions))
@test_throws
end

function test_dont_mask_non_attribute_error_in_cls_arg(self::@like(TestIsSubclassExceptions))
@test_throws
end

function test_mask_attribute_error_in_cls_arg(self::@like(TestIsSubclassExceptions))
@test_throws
end


@oodef mutable struct AbstractClass <: object
                    
                    bases
                    
function new(bases, __bases__ = property(getbases))
@mk begin
bases = bases
end
end
                ...
                function getbases(self::@like(AbstractClass))
return self.bases
end

function __call__(self::@like(AbstractClass))::AbstractInstance
return AbstractInstance()
end


@oodef mutable struct AbstractInstance <: object
                    
                    klass
                    
function new(klass, __class__ = property(getclass))
@mk begin
klass = klass
end
end
                ...
                function getclass(self::@like(AbstractInstance))
return self.klass
end
...
@oodef mutable struct Child <: Super
...
@oodef mutable struct A
                ...
                function __bases__(self::@like(A))::Tuple
return (Int64,)
end
...
x = x
                ...
                function __bases__(self::@like(B))
return (A(),)
end
...
@oodef mutable struct X
                ...
                function __bases__(self::@like(X))
return self.__bases__
end


@oodef mutable struct Failure <: object
                    
                    
                    
                end
                function Base.getproperty(self::@like(Failure), attr::Symbol)
...
@oodef mutable struct X
                ...
                function __bases__(self::@like(X))::Tuple
...
@oodef mutable struct X
                ...
                function Base.getproperty(self::@like(X), attr::Symbol)
                if hasproperty(self, Symbol(attr))
                    return Base.getfield(self, Symbol(attr))
                end
                @test (attr == "__bases__")
...
@oodef mutable struct TestIsInstanceIsSubclass <: unittest.TestCase
                    
                    
                    
                end
                function test_isinstance_normal(self::@like(TestIsInstanceIsSubclass))
...
function test_isinstance_abstract(self::@like(TestIsInstanceIsSubclass))
...
function test_subclass_normal(self::@like(TestIsInstanceIsSubclass))
...
function test_subclass_abstract(self::@like(TestIsInstanceIsSubclass))
...
function test_subclass_tuple(self::@like(TestIsInstanceIsSubclass))
@test (true == Child <: (Child,))
@test (true == Child <: (Super,))
@test (false == Super <: (Child,))
...
@test (false == Child <: ())
@test (true == Super <: (Child, (Super,)))
@test (true == Int64 <: (Int64, (Float64, Int64)))
@test (true == String <: (String, (Child, String)))
end

function test_subclass_recursion_limit(self::@like(TestIsInstanceIsSubclass))
support.infinite_recursion() do 
@test_throws
end
end

function test_isinstance_recursion_limit(self::@like(TestIsInstanceIsSubclass))
support.infinite_recursion() do 
@test_throws
end
end

function test_issubclass_refcount_handling(self::@like(TestIsInstanceIsSubclass))
@test (true == B() <: Int64)
end

function test_infinite_recursion_in_bases(self::@like(TestIsInstanceIsSubclass))
support.infinite_recursion() do 
@test_throws
@test_throws
@test_throws
...
function test_infinite_recursion_via_bases_tuple(self::@like(TestIsInstanceIsSubclass))
#= Regression test for bpo-30570. =#
support.infinite_recursion() do 
@test_throws RecursionError do 
Failure() <: Int64
end
end
end

function test_infinite_cycle_in_bases(self::@like(TestIsInstanceIsSubclass))
#= Regression test for bpo-30570. =#
support.infinite_recursion() do 
@test_throws
end
...
function test_infinitely_many_bases(self::@like(TestIsInstanceIsSubclass))
#= Regression test for bpo-30570. =#
support.infinite_recursion() do 
@test_throws
end
...
for cnt in 0:sys.getrecursionlimit() + 4
tuple_arg = (tuple_arg,)
fxn(arg, tuple_arg)
end
end
