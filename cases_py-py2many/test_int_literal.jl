...
@oodef mutable struct TestHexOctBin <: unittest.TestCase
                    
                    
                    
                end
                function test_hex_baseline(self::@like(TestHexOctBin))
@test (0 == 0)
@test (1 == 1)
...
function test_hex_unsigned(self::@like(TestHexOctBin))
...
function test_oct_baseline(self::@like(TestHexOctBin))
@test (0 == 0)
@test (1 == 1)
@test (342391 == 342391)
@test (0 == 0)
...
function test_oct_unsigned(self::@like(TestHexOctBin))
@test (2147483648 == 2147483648)
@test (4294967295 == 4294967295)
@test (-2147483648 == -2147483648)
@test (-4294967295 == -4294967295)
...
function test_bin_baseline(self::@like(TestHexOctBin))
@test (0 == 0)
@test (1 == 1)
@test (1365 == 1365)
@test (0 == 0)
...
function test_bin_unsigned(self::@like(TestHexOctBin))
@test (2147483648 == 2147483648)
@test (4294967295 == 4294967295)
@test (-2147483648 == -2147483648)
@test (-4294967295 == -4294967295)
