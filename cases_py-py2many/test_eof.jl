...
@oodef mutable struct EOFTestCase <: unittest.TestCase
                    
                    
                    
                end
                function test_EOF_single_quote(self::@like(EOFTestCase))
expect = "unterminated string literal (detected at line 1) (<string>, line 1)"
for quote_ in ("\'", "\"")
try
py""$(quote_)this is a test                ""
catch exn
 let msg = exn
...
function test_EOFS(self::@like(EOFTestCase))
...
function test_EOFS_with_file(self::@like(EOFTestCase))
...
function test_eof_with_line_continuation(self::@like(EOFTestCase))
...
function test_line_continuation_EOF(self::@like(EOFTestCase))
#= A continuation at the end of input must be an error; bpo2180. =#
expect = "unexpected EOF while parsing (<string>, line 1)"
@test_throws SyntaxError do excinfo 
py""""x = 5\\""""
end
...
function test_line_continuation_EOF_from_file_bpo2180(self::@like(EOFTestCase))
