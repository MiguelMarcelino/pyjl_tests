...
abstract type AbstractNamespaceFormatter <: string.Formatter end
abstract type AbstractCallFormatter <: string.Formatter end
abstract type AbstractXFormatter <: string.Formatter end
abstract type AbstractBarFormatter <: string.Formatter end
abstract type AbstractCheckAllUsedFormatter <: string.Formatter end
abstract type AbstractTestTemplate end
abstract type AbstractPathPattern <: Template end
abstract type AbstractMyPattern <: Template end
abstract type AbstractBadPattern <: Template end
abstract type AbstractMyTemplate <: Template end
abstract type AbstractAmpersandTemplate <: Template end
abstract type AbstractPieDelims <: Template end
...
@test (capwords("abc def ghi") == "Abc Def Ghi")
@test (capwords("abc\tdef\nghi") == "Abc Def Ghi")
@test (capwords("abc\t   def  \nghi") == "Abc Def Ghi")
@test (capwords("ABC DEF GHI") == "Abc Def Ghi")
@test (capwords("ABC-DEF-GHI", "-") == "Abc-Def-Ghi")
@test (capwords("ABC-def DEF-ghi GHI") == "Abc-def Def-ghi Ghi")
@test (capwords("   aBc  DeF   ") == "Abc Def")
@test (capwords("\taBc\tDeF\t") == "Abc Def")
@test (capwords("\taBc\tDeF\t", "\t") == "\tAbc\tDef\t")
end
...
@test_throws TypeError string.Formatter.format()
end
...
Channel() do ch_test_override_parse 
...
s = Template("\$who likes \$what")
d = dict("t\xffm", "fþ\fed")
@test (substitute(s, d) == "t\xffm likes fþ\fed")
end
