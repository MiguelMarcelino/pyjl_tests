...
def test():
    ...
    lbcom = win32com_.server.util.wrap(
        LockBytes(), pythoncom.IID_ILockBytes
    )  # , useDispatcher=win32com_.server.dispatcher.DispatcherWin32trace)
    ...
    doc = win32com_.client.Dispatch(oocom.QueryInterface(pythoncom.IID_IDispatch))
