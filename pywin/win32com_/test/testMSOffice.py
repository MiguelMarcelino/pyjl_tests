...
def TestWord():
    ...
    try:
        ...
        olerepr = win32com_.client.build.DispatchItem(typeinfo, attr, None, 0)
        ...
        word = win32com_.client.Dispatch("Word.Basic")
        TestWord7(word)
...
def TestAll():
    ...
    try:
        ...
        xl = win32com_.client.Dispatch("Excel.Application.5")
