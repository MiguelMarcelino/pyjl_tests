...
from win32com_.storagecon import *

import win32com_.test.util
from pywin32_testutil import str2bytes


class ShellTester(win32com_.test.util.TestCase):
...
class PIDLTester(win32com_.test.util.TestCase):
...
class FILEGROUPDESCRIPTORTester(win32com_.test.util.TestCase):
...
class FileOperationTester(win32com_.test.util.TestCase):
    def setUp(self):
        import tempfile
