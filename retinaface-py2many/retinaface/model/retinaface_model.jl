...
function load_weights(model)
    home = string(os.getenv("DEEPFACE_HOME", default = Path.home()))
...
function build_model()
    data = Input(dtype = tf.float32, shape = (nothing, nothing, 3), name = "data")
    bn_data = BatchNormalization(
        epsilon = 1.9999999494757503e-05,
        name = "bn_data",
        trainable = false,
    )(
        data,
    ...
    ssh_m3_det_context_conv1_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_c3_lateral_relu)
    ...
    ssh_m3_det_context_conv1_relu =
        ReLU(name = "ssh_m3_det_context_conv1_relu")(ssh_m3_det_context_conv1_bn)
    plus0_v2 = Add()([ssh_c2_lateral_relu, crop0])
    ssh_m3_det_context_conv2_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_m3_det_context_conv1_relu)
    ...
    ssh_m3_det_context_conv3_1_relu =
        ReLU(name = "ssh_m3_det_context_conv3_1_relu")(ssh_m3_det_context_conv3_1_bn)
    ssh_c2_aggr_relu = ReLU(name = "ssh_c2_aggr_relu")(ssh_c2_aggr_bn)
    ssh_m3_det_context_conv3_2_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_m3_det_context_conv3_1_relu)
    ...
    ssh_m2_red_up =
        UpSampling2D(size = (2, 2), interpolation = "nearest", name = "ssh_m2_red_up")(
            ssh_c2_aggr_relu,
        )
    ...
    ssh_m2_det_context_conv1_relu =
        ReLU(name = "ssh_m2_det_context_conv1_relu")(ssh_m2_det_context_conv1_bn)
    ...
    face_rpn_cls_score_reshape_stride32 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_score_reshape_stride32")
    ...
    ssh_m2_det_context_conv3_1_relu =
        ReLU(name = "ssh_m2_det_context_conv3_1_relu")(ssh_m2_det_context_conv3_1_bn)
    ssh_c1_aggr_relu = ReLU(name = "ssh_c1_aggr_relu")(ssh_c1_aggr_bn)
    face_rpn_cls_prob_stride32 =
        Softmax(name = "face_rpn_cls_prob_stride32")(face_rpn_cls_score_reshape_stride32)
    input_shape = [shape(tf, face_rpn_cls_prob_stride32)[k+1] for k = 0:3]
    sz = cast(tf.dtypes, input_shape[2] / 2, dtype = tf.int32)
    ...
    face_rpn_cls_prob_reshape_stride32 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_prob_reshape_stride32")
    ssh_m2_det_context_conv3_2_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_m2_det_context_conv3_1_relu)
    ...
    ssh_m1_det_context_conv1_relu =
        ReLU(name = "ssh_m1_det_context_conv1_relu")(ssh_m1_det_context_conv1_bn)
    ssh_m2_det_concat_relu = ReLU(name = "ssh_m2_det_concat_relu")(ssh_m2_det_concat)
    ssh_m1_det_context_conv2_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_m1_det_context_conv1_relu)
    ...
    face_rpn_cls_score_reshape_stride16 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_score_reshape_stride16")
    ...
    ssh_m1_det_context_conv3_1_relu =
        ReLU(name = "ssh_m1_det_context_conv3_1_relu")(ssh_m1_det_context_conv3_1_bn)
    ...
    face_rpn_cls_prob_reshape_stride16 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_prob_reshape_stride16")
    ssh_m1_det_context_conv3_2_pad =
        ZeroPadding2D(padding = tuple([1, 1]))(ssh_m1_det_context_conv3_1_relu)
    ...
    face_rpn_cls_score_reshape_stride8 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_score_reshape_stride8")
    ...
    face_rpn_cls_prob_stride8 =
        Softmax(name = "face_rpn_cls_prob_stride8")(face_rpn_cls_score_reshape_stride8)
    ...
    face_rpn_cls_prob_reshape_stride8 =
        transpose(tf, final, (1, 2, 3, 0), name = "face_rpn_cls_prob_reshape_stride8")
    model = Model(
        inputs = data,
        outputs = [
            face_rpn_cls_prob_reshape_stride32,
