...
hier_list
cs
dt::Vector{Union{Vector{Union{Tuple{Int64}, String, Tuple{Union{Int64, String}}, Any}}, Vector{Union{Tuple{Int64}, String, Any}}}}
style

            dynamic_browser(hli_root, cs = (((win32con.WS_CHILD | win32con.WS_VISIBLE) | commctrl.TVS_HASLINES) | commctrl.TVS_LINESATROOT) | commctrl.TVS_HASBUTTONS, dt::Vector{Union{Vector{Union{Tuple{Int64}, String, Tuple{Union{Int64, String}}, Any}}, Vector{Union{Tuple{Int64}, String, Any}}}} = [["Python Object Browser", (0, 0, 200, 200), style, nothing, (8, "MS Sans Serif")], ["SysTreeView32", nothing, win32ui.IDC_LIST1, (0, 0, 200, 200), cs]], style = win32con.WS_OVERLAPPEDWINDOW | win32con.WS_VISIBLE) = begin
...
list = HierListWithItems(GetDocument(self).root, win32ui.IDB_BROWSER_HIER, win32ui.AFX_IDW_PANE_FIRST)
...
function GetText(self::HLIInstance)::String
    return string(self.name) *
           " (Instance of class " *
           string(self.myobject.__class__.__name__) *
           ")"
end
