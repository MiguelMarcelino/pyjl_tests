...
eventInstance
            ...
            SimpleConnection(coInstance = nothing, eventInstance = nothing, eventCLSID = 0, debug = nothing, cp = nothing, cookie = debug) = begin
...
function Connect(self::AbstractSimpleConnection, coInstance, eventInstance, eventCLSID = nothing)
try
