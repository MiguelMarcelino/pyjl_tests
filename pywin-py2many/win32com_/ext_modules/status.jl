...
CreateWindow(self.pbar, win32con.WS_CHILD | win32con.WS_VISIBLE, (10, 30, 310, 44), self, 1001)
...
PostThreadMessage(self.threadid, win32con.WM_QUIT, 0, 0)
end
