...
idpattern::String
                    ...
                    Template(pattern, template, braceidpattern = nothing, delimiter::String = "\$", flags = _re.IGNORECASE, idpattern::String = "(?a:[_a-z][_a-z0-9]*)") =
...
function _vformat(self::Formatter, format_string, args, kwargs, used_args, recursion_depth, auto_arg_index = 0)::Tuple
