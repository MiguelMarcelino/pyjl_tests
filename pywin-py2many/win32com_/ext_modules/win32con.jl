...
function PRIMARYLANGID(lgid)::Int64
return lgid & 1023
end

function SUBLANGID(lgid)::Int64
return lgid >> 10
end
...
function IMAGE_SNAP_BY_ORDINAL(Ordinal)::Bool
return (Ordinal & IMAGE_ORDINAL_FLAG) != 0
end

function IMAGE_ORDINAL(Ordinal)::Int64
...
PC_EXPLICIT = 2
PC_NOCOLLAPSE = 4
function GetRValue(rgb)::Int64
return rgb & 255
end

function GetGValue(rgb)::Int64
return (rgb >> 8) & 255
end

function GetBValue(rgb)::Int64
return (rgb >> 16) & 255
end
