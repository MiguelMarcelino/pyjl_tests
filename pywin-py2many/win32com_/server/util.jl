...
iid
                    ...
                    ListEnumerator(_iid_, _list_, index, _public_methods_::Vector{String} = ["Next", "Skip", "Reset", "Clone"], iid = pythoncom.IID_IEnumVARIANT) =
...
#= Creates a new COM collection object
    ...
    (the default is @Collection@).
     =#
return WrapObject(DefaultPolicy(cls(seq)), pythoncom.IID_IDispatch, pythoncom.IID_IDispatch)
end
...
_public_methods_::Vector{String}
                    ...
                    FileStream(file, _com_interfaces_::Vector = [pythoncom.IID_IStream], _public_methods_::Vector{String} = ["Read", "Write", "Clone", "CopyTo", "Seek"]) =
