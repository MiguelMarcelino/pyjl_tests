...
_public_methods_::Vector{String}
                    ...
                    ConnectableServer(_connect_interfaces_, connections::Dict, cookieNo::Int64, _com_interfaces_::Vector = [pythoncom.IID_IConnectionPoint, pythoncom.IID_IConnectionPointContainer], _public_methods_::Vector{String} = append!(IConnectionPointContainer_methods, IConnectionPoint_methods)) =
...
try
interface = QueryInterface(pUnk, self._connect_interfaces_[1], pythoncom.IID_IDispatch)
catch exn
