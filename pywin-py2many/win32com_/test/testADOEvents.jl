...
function OnBeginTransComplete(self::AbstractADOEvents, TransactionLevel, pError, adStatus, pConnection)
#= pass =#
end
...
function OnExecuteComplete(self::AbstractADOEvents, RecordsAffected, pError, adStatus, pCommand, pRecordset, pConnection)
#= pass =#
end

function OnWillExecute(self::AbstractADOEvents, Source, CursorType, LockType, Options, adStatus, pCommand, pRecordset, pConnection)
#= pass =#
end
