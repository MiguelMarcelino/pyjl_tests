...
for field in fields
@printf("  %s, size=%d, reqd=%d, type=%d, defVal=%s\n", (field.Name, field.Size, field.Required, field.Type, string(field.DefaultValue)))
end
end
...
@printf("  %s - updated %s ( ", (doc.Name, timeStr))
