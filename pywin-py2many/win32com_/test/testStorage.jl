...
pss = StgOpenStorageEx(fname, m, storagecon.STGFMT_FILE, 0, pythoncom.IID_IPropertySetStorage)
psuser = Create(pss, pythoncom.FMTID_UserDefinedProperties, pythoncom.IID_IPropertySetStorage, storagecon.PROPSETFLAG_DEFAULT, (storagecon.STGM_READWRITE | storagecon.STGM_CREATE) | storagecon.STGM_SHARE_EXCLUSIVE)
...
psuser = nothing
pssum = Create(pss, pythoncom.FMTID_SummaryInformation, pythoncom.IID_IPropertySetStorage, storagecon.PROPSETFLAG_DEFAULT, (storagecon.STGM_READWRITE | storagecon.STGM_CREATE) | storagecon.STGM_SHARE_EXCLUSIVE)
WriteMultiple(pssum, (storagecon.PIDSI_AUTHOR, storagecon.PIDSI_COMMENTS), ("me", "comment"))
pssum = nothing
pss = nothing
pssread = StgOpenStorageEx(fname, storagecon.STGM_READ | storagecon.STGM_SHARE_EXCLUSIVE, storagecon.STGFMT_FILE, 0, pythoncom.IID_IPropertySetStorage)
found_summaries = []
...
ps = Open(pssread, pythoncom.FMTID_UserDefinedProperties, storagecon.STGM_READ | storagecon.STGM_SHARE_EXCLUSIVE)
for p in ps
