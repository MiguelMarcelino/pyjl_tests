...
using win32com_.test.util: CheckClean, TestCase, CapturingFunctionTestCase, ShellTestCase, TestLoader, TestRunner, RegisterPythonServer
verbosity = 1
...
function testit(self::AbstractPippoTest)
...
try
opts, args = getopt()(append!([PROGRAM_FILE], ARGS)[2:end], "v")
catch exn
 let why = exn
