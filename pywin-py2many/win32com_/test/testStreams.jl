...
_public_methods_::Vector{String}
                    ...
                    Persists(data, dirty::Int64, _com_interfaces_::Vector = [pythoncom.IID_IPersistStreamInit], _public_methods_::Vector{String} = ["GetClassID", "IsDirty", "Load", "Save", "GetSizeMax", "InitNew"]) =
...
_public_methods_::Vector{String}
                    ...
                    Stream(data, index::Int64, _com_interfaces_::Vector = [pythoncom.IID_IStream], _public_methods_::Vector{String} = ["Read", "Write", "Seek"]) =
...
s2 = wrap(s, pythoncom.IID_IStream)
p2 = wrap(p, pythoncom.IID_IPersistStreamInit)
